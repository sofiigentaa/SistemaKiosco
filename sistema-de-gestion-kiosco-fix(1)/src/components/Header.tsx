...
export const Header: React.FC<HeaderProps> = ({ onOpenCashModal, onOpenSyncModal, onOpenClearModal }) => {
  const { 
    activeTab, 
    setActiveTab, 
    totalAlertsCount, 
        ...
        <div className="flex items-center justify-between h-14 gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <span className="font-mono">
                    {kioskPin ? kioskPin : 'Conectar Celulares'}
                  </span>
                </button>
              </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Iniciar cobro rápido (F2)"
            >
              <Plus className="w-3.5 h-3.5" />
              <span className="hidden sm:inline">Nueva Venta (F2)</span>
